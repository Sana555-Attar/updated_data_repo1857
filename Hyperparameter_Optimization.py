...
task = Task.init(project_name='Sarcasm Detection Hyper-Parameter Optimization',
                 task_name='Saracasm Detection Automatic Hyper-Parameter Optimization',
...
if not args['template_task_id']:
    args['template_task_id'] = Task.get_task(
        project_name='tf_sarcasm_detector', task_name='TF 2.0 Sequence Model Training').id
    
print(f"template_task_id :{args['template_task_id']}")
...
an_optimizer = HyperParameterOptimizer(
    ...
    hyper_parameters=[
        UniformIntegerParameterRange('General/embedding_dim', min_value=8, max_value=32, step_size=8),
        DiscreteParameterRange('General/subset_size', values=[1000,1500]),
        DiscreteParameterRange('General/max_length', values=[50,100]),
        DiscreteParameterRange('General/num_epochs', values=[10,20,50,100,500]),
    ],
